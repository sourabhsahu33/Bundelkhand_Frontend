...
const Navbar = ({LoggedOut}) => {
  ...
  return (
    <nav id="nav_container" className='navbar'>
      ...
      <div className="logo">हमाओ<span>बुंदेलखंड</span></div>
      ...
      <button className="loggedoutbtn_icon" onClick={loggedout}><i className="fa-solid fa-right-from-bracket"></i></button>
      <button className='menu' onClick={updateElements}><i className="fa-solid fa-bars"></i></button>
    </div>
    </nav>
  );
}
